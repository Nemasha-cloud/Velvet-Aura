			...
			<center>
				...
				<div class="search">
					<form method="post" action="search.php">
						...
						<input type="submit" name="serachBtn" id="search_btn" value="Search">
					</form>
				</div>
				...
				<form method="post">
					<select name="currency" onchange="this.form.submit()" style="background-color: transparent; border: 1px solid #ccc; padding: 5px 10px; border-radius: 5px; font-size: 16px; color: #333; vertical-align: middle; margin-left: 788px; margin-top: -24px;">
						<option value="LKR" <?php echo ($_SESSION['currency'] == 'LKR') ? 'selected' : ''; ?>>LKR</option>
