...
<head>
    <meta charset="UTF-8">
    <title>Men's Items - Online Fashion Store</title>
        ...
        <div class="left-side">
            <form method="get" name="selection-box" style="background-color: #9e9e9e59; justify-content: center; margin: 48px 0;">
                ...
                <div class="categories">
                    ...
                    <input type="checkbox" name="cat[]" value="LONG SLEEVES SHIRT">
                    <label>Long sleeves shirt</label><br>
                    <input type="checkbox" name="cat[]" value="SHORT SLEEVES SHIRT">
                    <label>Short sleeves shirt</label><br>
                    <input type="checkbox" name="cat[]" value="T-SHIRT">
                    <label>T-shirt</label><br>
                    <input type="checkbox" name="cat[]" value="TROUSERS">
